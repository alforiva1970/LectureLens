    ...
    <div className="space-y-8">
      ...
      <div className="pt-8 border-t border-black/5 dark:border-white/10 space-y-4">
        ...
        <div className="flex flex-col gap-2">
          {isIframe && (
            <div className="p-3 rounded-xl bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/30 text-[10px] text-amber-700 dark:text-amber-400 leading-tight">
              L'accesso al disco è limitato nell'anteprima. Apri l'app in una nuova scheda per usare questa funzione.
            </div>
          )}
            ...
            {storageMode === 'browser' ? (
              <>
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-xl text-[10px] font-bold uppercase tracking-tighter transition-colors dark:text-white"
                  title="Salva la cronologia delle sessioni su un file locale (.json)"
                >
                ...
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2 px-3 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 rounded-xl text-[10px] font-bold uppercase tracking-tighter transition-colors dark:text-white"
                  title="Carica un file di cronologia (.json) salvato in precedenza"
                >
