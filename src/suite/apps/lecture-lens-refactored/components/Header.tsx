...
import { Sparkles, ShieldCheck, LayoutDashboard, Coffee, Key, Sun, Moon, MonitorDown } from 'lucide-react';
...
export function Header({
  darkMode, setDarkMode, setShowPrivacy, setForceWizard, isInstallable, handleInstall, bmcUrl
}: HeaderProps) {
  return (
